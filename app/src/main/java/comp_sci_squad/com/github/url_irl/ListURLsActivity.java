...
public class ListURLsActivity extends AppCompatActivity implements
    UriAdapter.ListItemClickListener {
  ...
  public static Intent newIntent(Context packageContext, ArrayList<String> stringListExtra,
      byte[] thumbnailExtra, long timePictureTakenExtra) {
  ...
  /**
   * Create an options menu. It will create - Share All Button
   *
   ...
   * the urls. The super class handles the back button.
   *
  ...
  public class UrlParseTask extends AsyncTask<String, Void, ArrayList<Uri>> {
     ...
     *
     * As a precondition: a url in the text MUST have spaces before and after it. as URLs rules
     * allow very diverse strings. Called automatically by the async task.
     *
     ...
     *
     * Sets the intent for the share all button with the URLs. Gives all the URLs to the recycle
     * view's adapter. Called automatically by the async task.
     *
